# /CSharpForge/gui/csharpforge_window.py
# CSharpForge GUI Window (Tabbed IDE Layout)
...
# =======================================
# CSHARP FORGE WINDOW CLASS
# =======================================
class CSharpForgeWindow(QMainWindow):
    """
    CSharpForge GUI (Tabbed IDE Layout)
    ...
    def __init__(self, llm_engine, storage_root: Path, parent=None):
        """
            -class initializer for llm_engine, prompt_builder, forge_writer
            -initializes the window, and GUI widgets
        """
        ...
        self.setWindowTitle("CSharpForge — C# Script Forge")
    ...
    def _build_ui(self):
        ...
        self.extracted_code_edit.setPlaceholderText(
            "Extracted C# code from LLM output and Deep Analysis will appear here.\n"
...
# ==================================================================
    ...
    def _on_generate_clicked(self):
        ...
        if not topic:
            QMessageBox.warning(self, "CSharpForge", "Please enter a forge topic.")
            return
    ...
    def _on_rerun_clicked(self):
        ...
        if not topic and not self._last_topic:
            QMessageBox.warning(self, "CSharpForge", "No topic available.")
            return
    ...
    def _on_approve_clicked(self):
        ...
        if not code:
            QMessageBox.warning(self, "CSharpForge", "No code in Master Code.")
            return
    ...
    def _on_save_clicked(self):
        ...
        if not code.strip():
            QMessageBox.warning(self, "CSharpForge", "No code to save.")
            return
    ...
    def _on_open_clicked(self):
        ...
        try:
            ...
            QMessageBox.critical(self, "CSharpForge", f"Failed to open file: {e}")
            return
    ...
    def _on_deep_analysis_clicked(self):
        code = self.master_code_edit.toPlainText().strip()
        if not code:
            QMessageBox.warning(self, "CSharpForge", "No code to analyze.")
            return
        ...
        if not corrected or not corrected.strip():
            QMessageBox.warning(self, "CSharpForge", "Deep Analysis produced no corrected code.")
            return
    ...
    def _run_forge(self, topic: str, use_feedback: bool):
        ...
        if not code:
            self.status_label.setText("No valid C# code found.")
            QMessageBox.warning(self, "CSharpForge", "No valid C# code found.")
            return
...
# ================================================================
    ...
    def _extract_code(self, raw: str):
        ...
        match = re.search(
            r"^(namespace |class |public |private |protected |internal )",
            raw,
            flags=re.MULTILINE,
        )
