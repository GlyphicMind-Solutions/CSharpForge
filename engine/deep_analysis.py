# /CSharpForge/engine/deep_analysis.py
# CSharpForge Deep Analysis Engine
...
class DeepAnalysisEngine:
    """
    Deep Analysis Engine v2 for CSharpForge
...
# =============================== #
    ...
    def summarize_chunk(self, chunk: str, index: int, total: int) -> str:
        topic = (
            "Summarize this C# code for later reconstruction. "
            "Focus on namespaces, classes, methods, inheritance, logic flow, and relationships:\n\n"
            f"{chunk}"
        )
    ...
    def merge_summaries(self, summaries: List[str]) -> str:
        ...
        topic = (
            "Merge these C# code summaries into a single, coherent project summary. "
            "Describe namespaces, classes, methods, dependencies, and architecture:\n\n"
            f"{joined}"
        )
    ...
    def analyze_from_summary(self, meta_summary: str) -> str:
        topic = (
            "Using ONLY this project summary, reconstruct or refactor the C# code. "
            "Preserve logic, improve structure, ensure correctness, and output ONLY C# code:\n\n"
            f"{meta_summary}"
        )
